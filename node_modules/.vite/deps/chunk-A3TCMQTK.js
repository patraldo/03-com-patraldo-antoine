...
var decorateProperty = ({ finisher, descriptor }) => (protoOrDescriptor, name) => {
  ...
  if (name !== void 0) {
    ...
    const key = (
      ...
      (_a5 = protoOrDescriptor.originalKey) !== null && _a5 !== void 0 ? _a5 : protoOrDescriptor.key
    );
  ...
  return decorateProperty({
    descriptor: (name) => {
      const descriptor = {
        get() {
          var _a5, _b4;
          return (_b4 = (_a5 = this.renderRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelector(selector)) !== null && _b4 !== void 0 ? _b4 : null;
        },
        enumerable: true,
        configurable: true
      };
      if (cache) {
        ...
        descriptor.get = function() {
          var _a5, _b4;
          if (this[key] === void 0) {
            this[key] = (_b4 = (_a5 = this.renderRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelector(selector)) !== null && _b4 !== void 0 ? _b4 : null;
          }
          return this[key];
        };
      }
  ...
  return decorateProperty({
    descriptor: (_name) => ({
      get() {
        ...
        const slotEl = (_a5 = this.renderRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelector(slotSelector);
...
var adoptStyles = (renderRoot, styles3) => {
  if (supportsAdoptingStyleSheets) {
    renderRoot.adoptedStyleSheets = styles3.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet);
  } else {
    styles3.forEach((s) => {
...
var wrap = ENABLE_SHADYDOM_NOPATCH && ((_b = global3.ShadyDOM) === null || _b === void 0 ? void 0 : _b.inUse) && ((_c = global3.ShadyDOM) === null || _c === void 0 ? void 0 : _c.noPatch) === true ? global3.ShadyDOM.wrap : (node) => node;
...
var polyfillSupport = DEV_MODE ? global3.litHtmlPolyfillSupportDevMode : global3.litHtmlPolyfillSupport;
polyfillSupport === null || polyfillSupport === void 0 ? void 0 : polyfillSupport(Template, ChildPart);
((_d = global3.litHtmlVersions) !== null && _d !== void 0 ? _d : global3.litHtmlVersions = []).push("2.7.4");
if (DEV_MODE && global3.litHtmlVersions.length > 1) {
...
if (NODE_MODE4) {
  (_a3 = global4.customElements) !== null && _a3 !== void 0 ? _a3 : global4.customElements = customElements;
}
var DEV_MODE2 = true;
...
if (DEV_MODE2) {
  const issuedWarnings = (_b2 = global4.litIssuedWarnings) !== null && _b2 !== void 0 ? _b2 : global4.litIssuedWarnings = /* @__PURE__ */ new Set();
  ...
  if (((_c2 = global4.ShadyDOM) === null || _c2 === void 0 ? void 0 : _c2.inUse) && polyfillSupport2 === void 0) {
...
var ReactiveElement = class extends HTMLElement {
   ...
   * @category styles
   */
  static finalizeStyles(styles3) {
    const elementStyles = [];
    if (Array.isArray(styles3)) {
      const set = new Set(styles3.flat(Infinity).reverse());
      for (const s of set) {
        elementStyles.unshift(getCompatibleStyle(s));
      }
    } else if (styles3 !== void 0) {
      elementStyles.push(getCompatibleStyle(styles3));
    }
...
((_d2 = global4.reactiveElementVersions) !== null && _d2 !== void 0 ? _d2 : global4.reactiveElementVersions = []).push("1.6.2");
...
var issueWarning3;
if (DEV_MODE3) {
  const issuedWarnings = (_a4 = globalThis.litIssuedWarnings) !== null && _a4 !== void 0 ? _a4 : globalThis.litIssuedWarnings = /* @__PURE__ */ new Set();
...
if (!isServer) {
  FOR_ATTRIBUTE_OBSERVER = new MutationObserver((records) => {
    ...
    for (const record of records) {
      (_a5 = record.target[ATTACHABLE_CONTROLLER]) == null ? void 0 : _a5.hostConnected();
    }
  });
}
  ...
  handleEvent(event) {
    ...
    switch (event.type) {
      default:
        return;
      case "focusin":
        this.visible = ((_a5 = this.control) == null ? void 0 : _a5.matches(":focus-visible")) ?? false;
        break;
      case "focusout":
      case "pointerdown":
        this.visible = false;
...
var Ripple = class extends LitElement {
  ...
  startPressAnimation(positionEvent) {
    ...
    this.pressed = true;
    (_a5 = this.growAnimation) == null ? void 0 : _a5.cancel();
...
@material/web/internal/controller/events.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-A3TCMQTK.js.map
